...
int main(){
    ...
    while(!q.empty()){
        ...
        if(seen[now.first][now.second]) continue;
        ...
        if('a' <= S[now.first][now.second] && S[now.first][now.second] <= 'z'){
            if(cseen[S[now.first][now.second]-'a']) continue;
            cseen[S[now.first][now.second]-'a'] = 1;
            rep(i,0,H){
                rep(j,0,W){
                    if(seen[i][j] != 1 && S[i][j] ==  S[now.first][now.second]){
                        q.push({i,j});
                        nq.push(num+1);
                    }
                }
